...
local function MakeRequest(method, endpoint, data, callback)
    ...
    local requestCallback = function(statusCode, responseText, responseHeaders)
        ...
        elseif not success then
            -- Failures always print (regardless of debug flag) so silent
            -- 401/500/etc are visible in the server console.
...
function API.Send911Call(callData, callback)
    ...
    local payload = {
        ...
        description = callData.description, -- body of the /911 message
